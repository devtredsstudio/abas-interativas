...
> *(Imagens demonstrativas de cada aba em funcionamento. Adicione os arquivos de print no repositório para exibição correta.)*
...
- Animações de entrada ao mudar de aba
